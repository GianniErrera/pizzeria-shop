	    		...
	    		<div class="col-lg-8 ftco-animate p-md-5">
		          ...
		          <div class="col-md-12 nav-link-wrap mb-5">
		            <div class="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        @forelse ($categories as $category)
                            <a class="nav-link active" id="v-pills-{{$loop->index + 1}}-tab" data-toggle="pill" href="#v-pills-{{$loop->index + 1}}" role="tab" aria-controls="v-pills-{{$loop->index + 1}}" aria-selected="{{$loop->index == 0 ?? "true" }}">
		          ...
		          <div class="col-md-12 d-flex align-items-center">
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
                        @forelse ($categories as $category)
                            <div class="tab-pane fade show  " id="v-pills-{{$loop->index + 1}}" role="tabpanel" aria-labelledby="v-pills-{{$loop->index + 1}}-tab">
                                <div class="row">


                                        @forelse($category->products as $product) {{$category->products->count()}}
                                        <div class="col-md-4 text-center">
                                            <div class="menu-wrap">
                                                <a href="#" class="menu-img img mb-4" style="background-image: url(images/{{$category->name}}-{{$loop->index + 1}}.jpg);"></a>
                                                <div class="text">
